  ...
  <section id="projets" class="container mb-5" data-aos="fade-up">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb-4" data-aos="fade-up">
        <div class="card">
          <img src="images/paralix.jpg" class="card-img-top" alt="Bannière du projet Paralix" style="height: 200px; object-fit: cover;">
          <div class="card-body">
      ...
      <div class="col-md-6 mb-4" data-aos="fade-up">
        <div class="card h-100 experience-hover">
          <img src="images/macrosoft-helpdesk.jpg" class="card-img-top" alt="Bannière du projet Macrosoft Helpdesk" style="height: 200px; object-fit: cover;">
          <div class="card-body">
